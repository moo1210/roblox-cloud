...
export class BadgesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1BadgesIconsGet(badgeIds: Array<number>, size?: '150x150', format?: 'Png' | 'Webp', isCircular?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'badgeIds' is not null or undefined
        if (badgeIds === null || badgeIds === undefined) {
            throw new RequiredError("BadgesApi", "v1BadgesIconsGet", "badgeIds");
        }
...
export class BadgesApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v1BadgesIconsGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1BadgesIconsGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse >> {
