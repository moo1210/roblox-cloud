...
export class GamePassesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1GamePassesGet(gamePassIds: Array<number>, size?: '150x150', format?: 'Png' | 'Webp', isCircular?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'gamePassIds' is not null or undefined
        if (gamePassIds === null || gamePassIds === undefined) {
            throw new RequiredError("GamePassesApi", "v1GamePassesGet", "gamePassIds");
        }
        ...
        // Query Params
        if (gamePassIds !== undefined) {
            requestContext.setQueryParam("gamePassIds", ObjectSerializer.serialize(gamePassIds, "Array<number>", "int64"));
        }

        // Query Params
        if (size !== undefined) {
            requestContext.setQueryParam("size", ObjectSerializer.serialize(size, "'150x150'", ""));
        }
...
export class GamePassesApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v1GamePassesGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1GamePassesGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse >> {
