 ...
 * no description
 */
export class DeveloperProductsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1DeveloperProductsIconsGet(developerProductIds: Array<number>, size?: '150x150' | '420x420', format?: 'Png' | 'Webp', isCircular?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        if (developerProductIds === null || developerProductIds === undefined) {
            throw new RequiredError("DeveloperProductsApi", "v1DeveloperProductsIconsGet", "developerProductIds");
        }
        ...
        // Query Params
        if (developerProductIds !== undefined) {
            requestContext.setQueryParam("developerProductIds", ObjectSerializer.serialize(developerProductIds, "Array<number>", "int64"));
        }
...
export class DeveloperProductsApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1DeveloperProductsIconsGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1DeveloperProductsIconsGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse >> {
