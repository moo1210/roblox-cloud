...
export class AssetFetchV2ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param expectedAssetType 
     */
    public async v2AssetHashHashGet(hash: string, acceptEncoding: string, robloxPlaceId: number, assetType: string, accept: string, assetFormat: string, robloxAssetFormat: string, skipSigningScripts?: boolean, clientInsert?: number, scriptinsert?: number, modulePlaceId?: number, serverplaceid?: number, expectedAssetType?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'hash' is not null or undefined
        if (hash === null || hash === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "hash");
        }


        // verify required parameter 'acceptEncoding' is not null or undefined
        if (acceptEncoding === null || acceptEncoding === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "acceptEncoding");
        }


        // verify required parameter 'robloxPlaceId' is not null or undefined
        if (robloxPlaceId === null || robloxPlaceId === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "robloxPlaceId");
        }


        // verify required parameter 'assetType' is not null or undefined
        if (assetType === null || assetType === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "assetType");
        }


        // verify required parameter 'accept' is not null or undefined
        if (accept === null || accept === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "accept");
        }


        // verify required parameter 'assetFormat' is not null or undefined
        if (assetFormat === null || assetFormat === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "assetFormat");
        }


        // verify required parameter 'robloxAssetFormat' is not null or undefined
        if (robloxAssetFormat === null || robloxAssetFormat === undefined) {
            throw new RequiredError("AssetFetchV2Api", "v2AssetHashHashGet", "robloxAssetFormat");
        }
        ...
        // Path Params
        const localVarPath = '/v2/assetHash/{hash}'
...
export class AssetFetchV2ApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v2AssetHashHashGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v2AssetHashHashGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RobloxWebAssetsIAssetResponseItemV2 >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RobloxWebAssetsIAssetResponseItemV2 = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
