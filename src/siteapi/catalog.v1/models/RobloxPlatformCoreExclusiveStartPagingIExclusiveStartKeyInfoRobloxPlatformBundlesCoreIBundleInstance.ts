...
export class RobloxPlatformCoreExclusiveStartPagingIExclusiveStartKeyInfoRobloxPlatformBundlesCoreIBundleInstance {
    /**
    *  [\'Asc\' = 1, \'Desc\' = 2]
    */
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "sortOrder",
            "baseName": "SortOrder",
            "type": "RobloxPlatformCoreExclusiveStartPagingIExclusiveStartKeyInfoRobloxPlatformBundlesCoreIBundleInstanceSortOrderEnum",
            "format": "int32"
        },
        {
            "name": "pagingDirection",
            "baseName": "PagingDirection",
            "type": "RobloxPlatformCoreExclusiveStartPagingIExclusiveStartKeyInfoRobloxPlatformBundlesCoreIBundleInstancePagingDirectionEnum",
            "format": "int32"
        },
        {
            "name": "count",
    ...
    static getAttributeTypeMap() {
        return RobloxPlatformCoreExclusiveStartPagingIExclusiveStartKeyInfoRobloxPlatformBundlesCoreIBundleInstance.attributeTypeMap;
    }
