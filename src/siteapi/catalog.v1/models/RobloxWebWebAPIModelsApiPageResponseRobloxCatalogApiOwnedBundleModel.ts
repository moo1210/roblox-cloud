...
export class RobloxWebWebAPIModelsApiPageResponseRobloxCatalogApiOwnedBundleModel {
    ...
    static getAttributeTypeMap() {
        return RobloxWebWebAPIModelsApiPageResponseRobloxCatalogApiOwnedBundleModel.attributeTypeMap;
    }
