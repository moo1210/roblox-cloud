...
export class RobloxWebWebAPIModelsApiPageResponseRobloxCatalogApiBundleDetailsModel {
    ...
    static getAttributeTypeMap() {
        return RobloxWebWebAPIModelsApiPageResponseRobloxCatalogApiBundleDetailsModel.attributeTypeMap;
    }
