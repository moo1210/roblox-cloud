...
export class BatchApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1AssetsBatchPost(robloxPlaceId: number, accept: string, robloxBrowserAssetRequest: string, assetRequestItems: Array<RobloxWebAssetsBatchAssetRequestItem>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'robloxPlaceId' is not null or undefined
        if (robloxPlaceId === null || robloxPlaceId === undefined) {
            throw new RequiredError("BatchApi", "v1AssetsBatchPost", "robloxPlaceId");
        }


        // verify required parameter 'accept' is not null or undefined
        if (accept === null || accept === undefined) {
            throw new RequiredError("BatchApi", "v1AssetsBatchPost", "accept");
        }
        ...
        if (robloxBrowserAssetRequest === null || robloxBrowserAssetRequest === undefined) {
            throw new RequiredError("BatchApi", "v1AssetsBatchPost", "robloxBrowserAssetRequest");
        }
        ...
        if (assetRequestItems === null || assetRequestItems === undefined) {
            throw new RequiredError("BatchApi", "v1AssetsBatchPost", "assetRequestItems");
        }


        // Path Params
        const localVarPath = '/v1/assets/batch';
...
export class BatchApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v1AssetsBatchPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1AssetsBatchPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<RobloxWebAssetsIAssetResponseItem> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<RobloxWebAssetsIAssetResponseItem> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<RobloxWebAssetsIAssetResponseItem>", ""
            ) as Array<RobloxWebAssetsIAssetResponseItem>;
