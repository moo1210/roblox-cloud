...
export class ObservableUniversesApi {
     ...
     */
    public v2UniversesUniverseIdShutdownPostWithHttpInfo(universeId: number, _options?: Configuration): Observable<HttpInfo<any>> {
        const requestContextPromise = this.requestFactory.v2UniversesUniverseIdShutdownPost(universeId, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v2UniversesUniverseIdShutdownPostWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param universeId The universe id.
     */
    public v2UniversesUniverseIdShutdownPost(universeId: number, _options?: Configuration): Observable<any> {
        return this.v2UniversesUniverseIdShutdownPostWithHttpInfo(universeId, _options).pipe(map((apiResponse: HttpInfo<any>) => apiResponse.data));
    }
