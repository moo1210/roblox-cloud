...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async toolboxServiceGetGroupCreations(ownerId: number, assetType: ToolBoxServiceAssetTypes, limit?: number, cursor?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (ownerId === null || ownerId === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetGroupCreations", "ownerId");
        }


        // verify required parameter 'assetType' is not null or undefined
        if (assetType === null || assetType === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetGroupCreations", "assetType");
        }
    ...
    public async toolboxServiceGetHomePageAssetsForSection(assetType: ToolBoxServiceAssetTypes, section: string, includeOnlyVerifiedCreators?: string, sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, locale?: string, placeId?: number, developerSegment?: string, assetsInCameraVicinity?: number, assetsInCameraViewport?: number, minPriceInCents?: number, maxPriceInCents?: number, qualityFilter?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'assetType' is not null or undefined
        if (assetType === null || assetType === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetHomePageAssetsForSection", "assetType");
        }


        // verify required parameter 'section' is not null or undefined
        if (section === null || section === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetHomePageAssetsForSection", "section");
        }
    ...
    public async toolboxServiceGetHomePageConfiguration(assetType: ToolBoxServiceAssetTypes, locale?: string, placeId?: number, developerSegment?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'assetType' is not null or undefined
        if (assetType === null || assetType === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetHomePageConfiguration", "assetType");
        }
    ...
    public async toolboxServiceGetUserCreations(userId: number, assetType: ToolBoxServiceAssetTypes, limit?: number, cursor?: string, separateModelsAndPackages?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        if (userId === null || userId === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetUserCreations", "userId");
        }


        // verify required parameter 'assetType' is not null or undefined
        if (assetType === null || assetType === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceGetUserCreations", "assetType");
        }
     ...
     */
    public async toolboxServiceSearchV1Audios(sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, keyword?: string, creatorType?: string, creatorTargetId?: number, minDuration?: number, maxDuration?: number, sortDirection?: string, artist?: string, album?: string, uiSortIntent?: string, tags?: string, includeOnlyVerifiedCreators?: string, querySource?: string, originalUserQuery?: string, originalCorrection?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param originalCorrection 
     */
    public async toolboxServiceSearchV1Decals(sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, keyword?: string, creatorType?: string, creatorTargetId?: number, uiSortIntent?: string, tags?: string, includeOnlyVerifiedCreators?: string, querySource?: string, originalUserQuery?: string, originalCorrection?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param robloxPlaceId 
     */
    public async toolboxServiceSearchV1GetAssets(assetType: ToolBoxServiceAssetTypes, sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, keyword?: string, assetSubTypes?: string, excludeAssetSubTypes?: string, creatorType?: string, creatorTargetId?: number, minDuration?: number, maxDuration?: number, sortDirection?: string, artist?: string, album?: string, uiSortIntent?: string, tags?: string, includeOnlyVerifiedCreators?: string, searchSource?: string, querySource?: string, originalUserQuery?: string, originalCorrection?: string, qualityFilter?: string, robloxPlaceId?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'assetType' is not null or undefined
        if (assetType === null || assetType === undefined) {
            throw new RequiredError("DefaultApi", "toolboxServiceSearchV1GetAssets", "assetType");
        }
     ...
     * @param originalCorrection 
     */
    public async toolboxServiceSearchV1Meshes(sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, keyword?: string, creatorType?: string, creatorTargetId?: number, uiSortIntent?: string, tags?: string, includeOnlyVerifiedCreators?: string, querySource?: string, originalUserQuery?: string, originalCorrection?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param originalCorrection 
     */
    public async toolboxServiceSearchV1Plugins(sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, keyword?: string, creatorType?: string, creatorTargetId?: number, uiSortIntent?: string, tags?: string, includeOnlyVerifiedCreators?: string, querySource?: string, originalUserQuery?: string, originalCorrection?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param originalCorrection 
     */
    public async toolboxServiceSearchV1Videos(sortOrder?: string, limit?: number, cursor?: string, pageNumber?: number, keyword?: string, creatorType?: string, creatorTargetId?: number, uiSortIntent?: string, tags?: string, includeOnlyVerifiedCreators?: string, querySource?: string, originalUserQuery?: string, originalCorrection?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class DefaultApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to toolboxServiceSearchV1Audios
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toolboxServiceSearchV1AudiosWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ToolBoxServiceSearchV1Result >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ToolBoxServiceSearchV1Result = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to toolboxServiceSearchV1Decals
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toolboxServiceSearchV1DecalsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ToolBoxServiceSearchV1Result >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ToolBoxServiceSearchV1Result = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to toolboxServiceSearchV1GetAssets
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toolboxServiceSearchV1GetAssetsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ToolBoxServiceSearchV1Result >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ToolBoxServiceSearchV1Result = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to toolboxServiceSearchV1Meshes
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toolboxServiceSearchV1MeshesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ToolBoxServiceSearchV1Result >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ToolBoxServiceSearchV1Result = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to toolboxServiceSearchV1Plugins
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toolboxServiceSearchV1PluginsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ToolBoxServiceSearchV1Result >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ToolBoxServiceSearchV1Result = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to toolboxServiceSearchV1Videos
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toolboxServiceSearchV1VideosWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ToolBoxServiceSearchV1Result >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ToolBoxServiceSearchV1Result = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
