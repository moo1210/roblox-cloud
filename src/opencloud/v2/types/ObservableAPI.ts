...
export class ObservableCloudApi {
     ...
     */
    public cloudAcceptGroupJoinRequestWithHttpInfo(group: string, joinRequest: string, acceptGroupJoinRequestRequest: AcceptGroupJoinRequestRequest, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.cloudAcceptGroupJoinRequest(group, joinRequest, acceptGroupJoinRequestRequest, _options);
     ...
     * @param acceptGroupJoinRequestRequest 
     */
    public cloudAcceptGroupJoinRequest(group: string, joinRequest: string, acceptGroupJoinRequestRequest: AcceptGroupJoinRequestRequest, _options?: Configuration): Observable<void> {
        return this.cloudAcceptGroupJoinRequestWithHttpInfo(group, joinRequest, acceptGroupJoinRequestRequest, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     */
    public cloudDeclineGroupJoinRequestWithHttpInfo(group: string, joinRequest: string, declineGroupJoinRequestRequest: DeclineGroupJoinRequestRequest, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.cloudDeclineGroupJoinRequest(group, joinRequest, declineGroupJoinRequestRequest, _options);
     ...
     * @param declineGroupJoinRequestRequest 
     */
    public cloudDeclineGroupJoinRequest(group: string, joinRequest: string, declineGroupJoinRequestRequest: DeclineGroupJoinRequestRequest, _options?: Configuration): Observable<void> {
        return this.cloudDeclineGroupJoinRequestWithHttpInfo(group, joinRequest, declineGroupJoinRequestRequest, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     */
    public cloudRestartUniverseServersWithHttpInfo(universe: string, restartUniverseServersRequest: RestartUniverseServersRequest, _options?: Configuration): Observable<HttpInfo<any>> {
        const requestContextPromise = this.requestFactory.cloudRestartUniverseServers(universe, restartUniverseServersRequest, _options);
     ...
     * @param restartUniverseServersRequest 
     */
    public cloudRestartUniverseServers(universe: string, restartUniverseServersRequest: RestartUniverseServersRequest, _options?: Configuration): Observable<any> {
        return this.cloudRestartUniverseServersWithHttpInfo(universe, restartUniverseServersRequest, _options).pipe(map((apiResponse: HttpInfo<any>) => apiResponse.data));
    }
